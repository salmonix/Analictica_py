...
class Corpus(object):
    ...
    # we should load it from file later. Here the type is stored instead of some obscure heuristics.
    # To read in various types from a diretory, we need a seria of tuples.
